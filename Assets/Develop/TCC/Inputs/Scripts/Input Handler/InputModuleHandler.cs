...
namespace nitou.LevelActors.Inputs {
    ...
    public sealed class InputModuleHandler : InputHandler {
        ...
        private void PrintInputWarning(string actionName) {
            Debug_.LogWarning($"{actionName} action not found! Please make sure this action is included in your input settings (axis). If you're only testing the demo scenes from " +
        ...
        private void PrintInputWarning(string actionXName, string actionYName) {
            Debug_.LogWarning($"{actionXName} and/or {actionYName} actions not found! Please make sure both of these actions are included in your input settings (axis). If you're only testing the demo scenes from " +
            "Character Controller Pro please load the input preset included at \"Character Controller Pro/OPEN ME/Presets/.");
        }
