...
namespace nitou.LevelActors.UI {
    ...
    public class IndicatorPin : ComponentBase {
        ...
        /// </summary>
        [SerializeField] UpdateTiming _cameraUpdateTiming;

        /// <summary>
        /// World coordinates of the UI.
        /// </summary>
        [SerializeField] Vector3 _worldPosition;
        ...
        private void OnDrawGizmosSelected() {
            ...
            Gizmos_.DrawSphere(position, 0.2f, Color.cyan);
        }
#endif
    }
}
