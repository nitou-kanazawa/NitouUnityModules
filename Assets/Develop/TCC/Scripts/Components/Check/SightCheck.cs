...
namespace nitou.LevelActors.Check {
    ...
    public class SightCheck : MonoBehaviour, IEarlyUpdateComponent {
        ...
        [SerializeField, Indent] Transform _headTransform;

        /// <summary>
        /// The range of the sight.
        /// </summary>
        [SerializeField, Indent] int _range = 10;

        /// <summary>
        /// The angle of the sight.
        /// </summary>
        [SerializeField, Indent] int _angle = 30;
        ...
        /// </summary>
        [SerializeField, Indent] string[] _targetTagList;
