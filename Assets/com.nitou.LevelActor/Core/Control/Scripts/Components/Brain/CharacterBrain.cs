...
namespace nitou.LevelActors.Controller.Brain {
    ...
    using nitou.LevelActors.Controller.Utils;
    ...
    public class CharacterBrain : BrainBase, IActorSettingUpdateReceiver {
        ...
        /// </summary>
        [SerializeField, Indent] bool3 _freezeAxis = new bool3(false, false, false);
