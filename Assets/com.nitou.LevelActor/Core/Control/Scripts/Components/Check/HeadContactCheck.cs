...
namespace nitou.LevelActors.Controller.Check {
    ...
    using Controller.Interfaces.Utils;
    ...
    public class HeadContactCheck : MonoBehaviour,
        ...
        [Range(0, 0.5f)]
        [SerializeField, Indent] float _headPositionOffset = 0.1f;
        ...
        [Range(0, 10f)]
        [SerializeField, Indent] float MaxHeight = 2.5f;
        ...
        /// </summary>
        [SerializeField, Indent] UnityEvent _onContact;
